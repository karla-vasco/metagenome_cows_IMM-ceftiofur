...
```{r}
setwd("/Users/karlavasco/OneDrive\ -\ Michigan\ State\ University/Manning_lab/Mastitis_project/figures/composition") 

library(ggplot2)
ggsave(plot = heat_tree, "heat-tree_genes.png", height = 9, width = 11)
```